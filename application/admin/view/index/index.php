...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element admin_open">
                        <span>
                            <img alt="image" class="imgbox" style="width: 50%" src="{$site_logo}" onerror="javascript:this.src='{__ADMIN_PATH}images/admin_logo.png';"/>
                        </span>
                        ...
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            ...
                            <li><a class="admin_close" target="_blank" href="http://www.xyzxkj.com/">联系我们</a>
                            </li>
                            <li class="divider"></li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="footer"  @touchmove.prevent>
            <div class="pull-right">© 2021 <a href="/admin" target="_blank">{$sitename}</a>
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
...
<script type="text/javascript">
     $(function() {
        //定时加入机器人
        function getnotice() {
            $.getJSON("{:Url('add_robot')}",function(res){
               console.log(1);
            });
        }
        getnotice();
        setInterval(getnotice, 180000);
            //定时拼团成功与否
        function is_robot() {
            $.getJSON("{:Url('is_robot')}",function(res){
               console.log(res,'拼团');
            });
        }
        is_robot();
        setInterval(is_robot, 60000);
