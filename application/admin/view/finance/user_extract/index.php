                    ...
                    <div class="m-b m-l">
                        <form action="" class="form-inline">
                            ...
                            <select name="extract_type"  class="form-control input-sm">
                                ...
                                {volist name='withdrawal' id='vo'}
                                <option value="{$vo.name}" {eq name="where.extract_type" value="$vo.name" }selected="selected"{/eq}>{$vo.name}</option>
                                {/volist}
                            ...
                            <div class="input-group">
                                  ...
                                  <span class="input-group-btn">
                                        <input type="text" name="nireid" value="{$where.nireid}" placeholder="用户邮箱" class="input-sm form-control" size="38">
                    ...
                    <table class="table table-striped  table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="text-left">
                                ...
                                {if condition="$vo['type_ti'] eq '1'"}
                                提现来源：余额<br>
                                提现方式:{$vo.extract_type}<br>
                                提现地址:{$vo.real_name}
                                {else/}
                                提现来源：佣金<br>
                                提现方式:{$vo.extract_type}<br>
