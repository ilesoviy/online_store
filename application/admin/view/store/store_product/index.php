            ...
            <div class="layui-card">
                <div class="layui-card-body">
                    <div class="alert alert-info" role="alert">
                        列表[产品价格],[虚拟销量],[库存]可进行快速修改,双击或者单击进入编辑模式,失去焦点可进行自动保存<br/>
                        属性添加 注意 属性名称要用英文状态下的~区分中文与英文
                    ...
                    <script type="text/html" id="act">
                        <button type="button" class="layui-btn layui-btn-xs btn-success" onclick="$eb.createModalFrame('{{d.store_name}}-属性','{:Url('attr')}?id={{d.id}}',{h:600,w:1100})">
                            属性
                        </button>
                        ...
                        <ul class="layui-nav-child layui-anim layui-anim-upbit">
                            ...
                            <li>
                                <a href="javascript:void(0);" class="" onclick="$eb.createModalFrame(this.innerText,'{:Url('en_edit_content')}?id={{d.id}}')">
                                    <i class="fa fa-pencil"></i> 英文详情详情</a>
                            </li>
                           <!--  <li>
