            ...
            <template v-for="(attr,index) in attrs">
                <Form-Item>
                    <Row>
                        ...
                        <i-Col span="3">
                            <span :class="attr.check ? 'check':''">拼团价:</span>&nbsp;&nbsp;<i-Input placeholder="拼团价" v-model="attr.pin_price" style="width: 60%"
                                                                                                   :number="true"></i-Input>
                        </i-Col>
                ...
                checkGoods(){
                    ...
                    this.attrs.map(function(attr){
                        ...
                        if(!Object.keys(attr.detail).length){
                            ...
                            bool = false;
                        }else if(attr.pin_price != parseFloat(attr.pin_price) || attr.pin_price < 0){
                            $eb.message('error','请输入正确的商品拼团价格');
                            bool = false;
                        }
                    });
                    return bool;
