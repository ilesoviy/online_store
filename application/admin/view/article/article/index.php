                ...
                <table class="footable table table-striped  table-bordered " data-page-size="20">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            {if condition="$vo['id'] gt 8"}
                            <button class="btn btn-warning btn-xs del_news_one" data-id="{$vo.id}" type="button" data-url="{:Url('delete',array('id'=>$vo['id']))}" ><i class="fa fa-warning"></i> 删除</button>
                            {/if}
